...
**BUT FIRST:** Yeah, you'll need to replace the APP_NONCE in the HTML files with
a nonce generated by your server. Then give the app access to the integrations
it needs.

**AND ALSO:** Change the URL from `https://localhost:9009/frbr.js` if you are
running Fresh Breath on a different URL.
...
These are designed to be small samples, just to get a quick sense of how the
